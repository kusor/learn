...
pub async fn get_course_details(
    ...
    let tutor_id: i32 = i32::try_from(tutor_id).unwrap();
...
mod tests {
    ...
    async fn get_course_detail_failure_test() {
        ...
        let params: web::Path<(usize, usize)> = web::Path::from((1, 21));
    ...
    async fn post_course_success() {
        ...
        let resp = new_course(course_param, app_state).await.unwrap();
        assert_eq!(resp.status(), StatusCode::OK);
    }
    ...
    async fn update_course_success() {
        ...
        let parameters: web::Path<(usize, usize)> = web::Path::from((1, 2));
    ...
    async fn delete_test_success() {
        ...
        let parameters: web::Path<(usize, usize)> = web::Path::from((1, 5));
    ...
    async fn delete_test_failure() {
        ...
        let parameters: web::Path<(usize, usize)> = web::Path::from((1, 21));
