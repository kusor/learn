...
// The Actix web framework serializes the incoming data payload into an Actix
// data type web::Json<CreateCourse>, but our application does not understand
// this type. So, we’ll have to convert this Actix type into a regular
// Rust struct.
